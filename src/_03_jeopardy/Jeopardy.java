...
public class Jeopardy implements ActionListener {
	...
	public void run() {
		...
		frame.setTitle("Shivam's Jeapordy");
		// 3. Create a JPanel variable to hold the header using the createHeader method
		JPanel Header = new JPanel();
		Header = createHeader("Facts and random stuff!");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (buttonPressed == firstButton) {
			...
			askQuestion("What percent of the world is vegetarian?*Hint less than 10 percent*", "8%", 300);
		...
		if (buttonPressed == secondButton) {
			...
			askQuestion("What year did India's independence occur?", "1947", 500);
		...
		if (buttonPressed == thirdButton) {
			// Call the askQuestion() method with a harder question
			askQuestion("When month is Independence day?", "July", 100);
			// Clear the text on the button that was pressed (set the button text to
			// nothing)
	...
	private void askQuestion(String question, String correctAnswer, int prizeMoney) {
		...
		String answer2 = JOptionPane.showInputDialog(null, question);
		String answer3 = JOptionPane.showInputDialog(null, question);
